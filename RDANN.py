...
# import random
import preprocess_dataset as process_data
...
class CNN_Fusion(nn.Module):
    def __init__(self, args):
        ...
        #bert_model = BertModel.from_pretrained('clue/roberta_chinese_base')
        # bert_model = BertModel.from_pretrained('ernie-3.0-base-zh')
        ...
        # IMAGE
        vgg_16 = torchvision.models.vgg19(pretrained=True)
        for param in vgg_16.parameters():
            param.requires_grad = False
        # visual model
        num_ftrs = vgg_16.classifier._modules['6'].out_features
        self.vgg = vgg_16
...
def main(args):
    ...
    print('Saving results')  # 修改代码的部分！！！！！！！！！！！！！！！000000000000

    # 修改代码的部分！！！！！！！！！！！！！！！1111111111111111
    # 修改代码的部分！！！！！！！！！！！！！！！11111111111

    # plot and save confusion matrix修改代码的部分！！！！！！！！！！！！！！！2222222222
    ...
    for i in range(2):
        for j in range(2):
            plt.text(j, i, test_confusion_matrix[i, j], ha='center', va='center')

    plt.savefig('D:/RDANN-FND/Data/weibo/confusion_matrix.png')
    # 修改代码的部分！！！！！！！！！！！！！！！2222222222
...
def get_top_post(output, label, test_id, top_n=500):
    ...
    pickle.dump(top_n_id_dict, open("D:/RDANN-FND/Data/weibo/top_n_id.pickle", "wb"))
...
def re_tokenize_sentence(flag):
    ...
    #tokenizer = BertTokenizer.from_pretrained("clue/roberta_chinese_base") #20230415屏蔽
    # tokenizer = AutoTokenizer.from_pretrained("ernie-3.0-base-zh")
    # seq_cls_model = AutoModelForSequenceClassification.from_pretrained("ernie-3.0-medium-zh")
    # AutoTokenizer.from_pretrained("ernie-3.0-base-zh", use_faster=True)
    #roberta = BertModel.from_pretrained("clue/roberta_chinese_base") #20230415屏蔽
    tokenized_texts = []
...
def load_data(args):
 ...
 # Add print statements to check the data
    print("Train data:")
    print(train['post_text'])
    print("Validate data:")
    print(validate['post_text'])
    print("Test data:")
...
if __name__ == '__main__':
    ...
    train = ''
    test = ''
    output = 'D:/RDANN-FND/Data/weibo/output_image_text1/'
